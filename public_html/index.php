...
<?php include("../includes/navbar.php"); ?>
	<div class="container">
		...
		<p>With those aside, there are several other reasons for exploration, such as a higher mutation level and fuel sources. In this website, we want you to learn as much as you can about Mars, what it is, why it’s important, and our plans to get there. So look, around, enjoy, and best of all, learn. As Buzz Aldrin once said, “Did the Pilgrims on the Mayflower sit around Plymouth Rock waiting for a return trip? They came here to settle. And that's what we should be doing on Mars.” Since we’re in this for the long run, it’s important that we prepare ourselves for the day that, we, too, might journey up into the stars and to the red planet.</p>
		<section>
